...
import os
import logging
# from typing import Optional # Không còn cần Optional cho SupabaseClient

from fastapi import HTTPException, status, Request as FastAPIRequest # Không còn cần SupabaseClient
# from supabase import create_client, Client as SupabaseClient, ClientOptions # Không còn cần
